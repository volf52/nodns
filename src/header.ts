...
class Header {
    ...
    constructor(flags: Flags,qd_count:number=1,an_count:number=0,ns_count:number=0,ar_count:number=0,z:number= 2,rcode:number = 0,) {
    ...
    parse(buf: Buffer):Header{
        ...
        assert (Buffer.byteLength(buf) >= 12)
